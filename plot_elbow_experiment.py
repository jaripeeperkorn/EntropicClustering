...
def generate_plots_from_results(logname, max_clusters, output_dir='experimental_results_elbow/plots'):
    ...
    """
    metrics = [
        'ER', 'graph_density', 'graph_entropy'
    ]
...
generate_plots_from_results('BPIC15', 10)
generate_plots_from_results('Hospital_Billing', 10)
generate_plots_from_results('BPIC12', 10)
generate_plots_from_results('Sepsis', 10)